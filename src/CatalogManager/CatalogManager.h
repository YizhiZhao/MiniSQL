...
public:
	...
	bool get_attribute(const std::string& table_name, std::vector<Attribute>& attributes); //get all attributes of a specific table
	...
	bool get_record(const std::string& table_name, std::vector<std::string>& record_content, char* record);
};
